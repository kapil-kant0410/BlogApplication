...
public class CommentService {
    ...
    public ResponseEntity<ApiResponse<String>> updateComment(Long id, CommentRequestDto commentRequestDto){
        ...
        Comment comment=commentRepository.findByUserIdAndId(userId,id).orElseThrow(()->new CommentNotFoundException("Comment not found"));
    ...
    public ResponseEntity<ApiResponse<String>> deleteComment(Long id){
        ...
        commentRepository.findByUserIdAndId(userId,id).orElseThrow(()->new CommentNotFoundException("Comment not found"));
